...
<script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-6431831424793010" crossorigin="anonymous"></script>
	...
	<link id="style1" rel="stylesheet" href="../css/style1.css">
	...
	function toggle() { // toggle
		...
		a.x = '../css/style2' == a.x ? '../css/style1' : '../css/style2'; //switch file loop
...
<body>
	<div id="songs" class="songs_Class">
		<svg data-type="Rectangle" data-name="upper-rechteck" class="upper-rechteck">
			<rect class="upper-rechteck_Class" rx="0" ry="0" x="0" y="0" width="2067" height="1154">
			</rect>
		</svg>
		<svg data-type="Path" data-name="middle-rechteck" class="middle-rechteck" viewBox="1964.243 645.958 2156.685 272.351">
			<path class="middle-rechteck_Class" d="M 2073.398193359375 645.958251953125 L 3041.956787109375 796.731201171875 L 4053.062255859375 648.6995849609375 L 4120.92822265625 648.6995849609375 L 4120.92822265625 918.30908203125 L 1964.243408203125 909.3997192382812 L 1964.243408203125 645.958251953125 L 2073.398193359375 645.958251953125 Z">
			</path>
		</svg>
		...
		<div data-type="Group" data-name="play-session" class="play-session_Class">
			...
			<?php if (isset($_GET["ID"])) {
				if ($_GET["ID"] == "6") { ?>
					...
					<video controls="" name="media">
						...
						$sql = "SELECT * FROM `song` WHERE PK_song_ID = :id";
						$statement = $pdo->prepare($sql);
						$statement->bindParam(":id", $_GET["ID"]);

						if ($statement->execute()) {
							if (($record = $statement->fetch()) != FALSE) {
								echo "<source class='video' src='../Benutzerverwaltung/songs/" . $record["Titel"] . ".mp4' type='audio/mp4'>";
							}
						} else {
					...
					<div class="player" style="z-index: 99;">
						<div class="left"></div>
						<div class="right">
							<div class="top">
								<div class="song"><?php
													echo "<span style='color:rgba(243, 29, 60, 1);font-weight:bold;'>" . $record["Titel"] . "</span>";

													?></div>
								<c class="artist"><?php

													$sql = "SELECT * FROM `song` JOIN künstler ON künstler.PK_künstler_ID = FK_PK_Künstler_ID WHERE PK_song_ID = :id";
													$statement = $pdo->prepare($sql);
													$statement->bindParam(":id", $_GET["ID"]);
						...
						<?php
						// if (isset($_POST["herz-like"])) {

						//update
						$sql_like = "SELECT * FROM `song_bewertung` WHERE FK_PK_user_ID = :u_id AND FK_PK_Song_ID = :id";
						$statement_like = $pdo->prepare($sql_like);
						$statement_like->bindParam(":id", $_GET["ID"]);
						$statement_like->bindParam(":u_id", $_SESSION["User_ID"]);

						if ($statement_like->execute()) {
							if (($record = $statement_like->fetch()) != FALSE) {

								echo '<a href="like_löschen.php?ID=' . $_GET["ID"] . '"><svg style="fill:rgba(243, 29, 60, 1);stroke:rgba(243, 29, 60, 1);" data-type="Path" data-name="Icon feather-heart" class="Icon_feather-heart" viewBox="2.323 4.497 23.19 20.227">' . $record["wert"] . '
							<path class="Icon_material-playlist-play_Class_2" d="M 35.52558517456055 15.29204845428467 L 3.000000476837158 15.29204845428467 L 3.000000476837158 19.18807029724121 L 35.52558517456055 19.18807029724121 L 35.52558517456055 15.29204845428467 Z M 35.52558517456055 7.499999523162842 L 3.000000476837158 7.499999523162842 L 3.000000476837158 11.39602375030518 L 35.52558517456055 11.39602375030518 L 35.52558517456055 7.499999523162842 Z M 3.000000476837158 26.98011779785156 L 27.87250328063965 26.98011779785156 L 27.87250328063965 23.08409690856934 L 3.000000476837158 23.08409690856934 L 3.000000476837158 26.98011779785156 Z M 31.69904136657715 23.08409690856934 L 31.69904136657715 34.77216720581055 L 41.26538848876953 28.92813301086426 L 31.69904136657715 23.08409690856934 Z">
							</path>
						</svg>
						<?php
						echo "<div class='dropdown-content_2'>";
						echo "<table style='border-spacing: 15px 5px;' ><tr style='color:rgba(212, 212, 212, 1);'> <th>Titel </th><th> Künstler </th><th> dauer </th><th> </th>";

						$song = "SELECT * FROM `song` LEFT JOIN künstler ON FK_PK_Künstler_ID = künstler.PK_Künstler_ID";
						$statement_song = $pdo->prepare($song);

						if ($statement_song->execute()) {
							while (($record_song = $statement_song->fetch()) != FALSE) {
								echo "<tr> <td> " . $record_song["Titel"] . "</td><td> " . $record_song["name"] . "</td><td> " . $record_song["Dauer"] . "</td> <td> <a href='songs.php?ID=" . $record_song["PK_song_ID"] . "'> <div class=''> jetzt anh&ouml;ren </a></div> </td></tr>";
							}
						} else {
							header('Location: index.php');
						}
				...
				<?php } else { ?>
						...
						<div class="right">
							...
							<div class="bottom">
								...
								<?php
														...
														if ($statement->execute()) {
															if (($record = $statement->fetch()) != FALSE) {
																echo "<source class='video' src='../Benutzerverwaltung/songs/" . $record["Titel"] . ".wav' type='audio/wav'>";
															}
														} else {
															header('Location: index.php');
														}
					...
					if ($statement_like->execute()) {
						if (($record = $statement_like->fetch()) != FALSE) {
							...
							echo '<a href="like_bewertung.php?ID=' . $_GET["ID"] . '"> <svg style="fill:transparent;stroke:rgba(243, 29, 60, 1);" name="herz-like" data-type="Path" data-name="Icon feather-heart" class="Icon_feather-heart" viewBox="2.323 4.497 23.19 20.227">
									<path class="Icon_feather-heart_Class" d="M 23.72516822814941 6.285449504852295 C 21.34203910827637 3.901199340820312 17.47702980041504 3.901199340820312 15.09389686584473 6.28545093536377 L 13.91791343688965 7.461433410644531 L 12.74193096160889 6.285449504852295 C 10.35847091674805 3.901989936828613 6.494118690490723 3.901989459991455 4.110659122467041 6.285449504852295 C 1.727198362350464 8.668909072875977 1.72719931602478 12.53326225280762 4.110659599304199 14.91672134399414 L 5.286642074584961 16.09270477294922 L 13.91791343688965 24.72397613525391 L 22.54918479919434 16.09270477294922 L 23.72516822814941 14.91672134399414 C 26.10942077636719 12.53358936309814 26.10942077636719 8.668581008911133 23.72516822814941 6.285448551177979 Z">
									</path></svg> </a>';
						}
					} else {
					...
					<div class='_dropdown'>
						<svg data-type="Path" data-name="Icon material-playlist-play" class="Icon_material-playlist-play" viewBox="3 7.5 38.265 27.272">
							<path class="Icon_material-playlist-play_Class" d="M 35.52558517456055 15.29204845428467 L 3.000000476837158 15.29204845428467 L 3.000000476837158 19.18807029724121 L 35.52558517456055 19.18807029724121 L 35.52558517456055 15.29204845428467 Z M 35.52558517456055 7.499999523162842 L 3.000000476837158 7.499999523162842 L 3.000000476837158 11.39602375030518 L 35.52558517456055 11.39602375030518 L 35.52558517456055 7.499999523162842 Z M 3.000000476837158 26.98011779785156 L 27.87250328063965 26.98011779785156 L 27.87250328063965 23.08409690856934 L 3.000000476837158 23.08409690856934 L 3.000000476837158 26.98011779785156 Z M 31.69904136657715 23.08409690856934 L 31.69904136657715 34.77216720581055 L 41.26538848876953 28.92813301086426 L 31.69904136657715 23.08409690856934 Z">
							</path>
						</svg>
						<?php
						echo "<div class='_dropdown-content'>";
						echo "<table style='border-spacing: 15px 5px;' ><tr style='color:rgba(212, 212, 212, 1);'> <th>Titel </th><th> Künstler </th><th> dauer </th><th> </th>";
		...
		<div class="comments_Class">
			<div class="textarea">
				<form method="POST" action="../Benutzerverwaltung/kommentare/kommentar_add.php">
					<textarea id="textarea" placeholder="Jetzt einen Kommentar schreiben..." name="tea" style="margin-top: 220px;margin-left:525px;;width:450px;height:180px;font-family: Montserrat;font-size: 18px; ;border-radius:10px;border: 2px solid #ccc; " class="form_textarea" rows="4" cols="50"></textarea>
					<input type="hidden" name="zeit" value="<?php echo (date("Y-m-d:H-i", time())); ?>"> <br />
					<input type="hidden" name="FK_PK_Song_ID" value="<?php echo $_GET["ID"]; ?>"> <br />
					<input type="submit" name="btn" style="margin-top:5px;;border-radius: 2px;margin-left: 885px;font-size: 25px;" value="senden">
				</form> <br />
			</div>
			<input type="hidden" id="song_id" value="<?php if (isset($_GET["ID"])) {
															echo  $_GET["ID"];
														} ?>">
			<div class="div_kommentar" id="div_kommentar"></div>


			<?php
			// $comments = "SELECT *, COUNT(PK_Kommentare_ID) AS 'Comments' FROM `kommentare`";
			// $statement_comments = $pdo->prepare($comments);
			// $statement_comments->bindParam(":id", $_GET["ID"]);
			// $statement_comments->bindParam(":u_id", $_SESSION["User_ID"]);

			// if ($statement_comments->execute()) {
			// 	if (($record_comments = $statement_comments->fetch()) != FALSE) {
			// 		echo '<div data-type="Text" data-name="38 comments" class="n_8_comments_Class"> <span>' . $record_comments["Comments"] . ' comments</span> </div>';
			// 	}
			// }

			// $song_comments = "SELECT * FROM kommentare RIGHT JOIN user ON PK_User_ID = FK_PK_User_ID WHERE FK_PK_Song_ID = :id";
			// $statement_song_comments = $pdo->prepare($song_comments);
			// $statement_song_comments->bindParam(":id", $_GET["ID"]);

			// if ($statement_song_comments->execute()) {
			// 	echo "<table> ";
			// 	while (($record_song_comments = $statement_song_comments->fetch()) != FALSE) {

			// 		echo '<tr> <div class="class">
			// 		<span>' . $record_song_comments["username"] . '</span><span style="font-style:normal;font-weight:normal;color:rgba(112,112,112,1);"> ' . $record_song_comments["datum"] . '</span>
			// 		<br /><span style="font-style:normal;font-weight:normal;font-size:26px;color:rgba(112,112,112,1);">' . $record_song_comments["inhalt"] . '</span> 

			// 		<svg class="Polygon_1">
			// 		<path class="Polygon_1_Class" d="M 9.499999046325684 0 L 19 18 L 0 18 Z">
			// 		</path>
			// 	</svg>
			// 	<div class="Alle_Antworten_anzeigen_Class">
			// 		<span>Alle Antworten anzeigen</span>
			// 	</div>
			// 	<div class="ANTWORTEN_Class">
			// 		<span>ANTWORTEN</span>
			// 		</div></div></tr>';
			// 	}
			// 	echo "</table>";
			...
			?>
			<!-- <div class="class">
				<span>atilla </span><span style="font-style:normal;font-weight:normal;color:rgba(112,112,112,1);">at 13:18 9 days ago</span><br /><span style="font-style:normal;font-weight:normal;font-size:26px;color:rgba(112,112,112,1);">Er ist erst seit kurzem Single. Die meisten Männer ticken nach einer Trennung ein wenig anders als Frauen. Statt sich daheim einzumurmeln und sich bei der besten Freundin auszuheulen, lenken sich die Herren der Schöpfung gerne ab und gehen auf Beutezug. Sei vorsichtig, vielleicht bist du die Beute!</span>
			</div> -->
			<div data-type="Text" data-name="KOMMANTARE" class="KOMMANTARE_Class">
					...
					<div data-type="Group" data-name="anmelden" class="anmelden_Class">
						...
						if ($stmt_select->execute()) {
							if (($record_select = $stmt_select->fetch()) != FALSE) {
								...
								echo "<div class='_dropdown-content_3' style='padding-left: 0px;padding-right: 16px;'> <table style='border-spacing: 15px 5px;'>
		<tr> <th> <a style='text-decoration: none; color:#551AA8;' href='../Benutzerverwaltung/profile.php'> zum Profile gehen</a></th></tr>
		<tr> <th> <a  onclick='toggle()' style='text-decoration: none; color:#FF0000;'> Dark/Light-Mode</a></th></tr>
		<tr> <th> <a style='text-decoration: none; color:#FF0000;' href='../Benutzerverwaltung/logout.php'> Abmelden</a></th></tr>
			...
			<a href="../index.php">
				<div data-type="Group" data-name="logo_1" class="logo_1_Class">
					<img data-type="Rectangle" data-name="kaddra schatten" class="kaddra_schatten_Class" src="kaddra_schatten.png" srcset="kaddra_schatten.png 1x, kaddra_schatten@2x.png 2x">
					<img data-type="Rectangle" data-name="kaddra" class="kaddra_Class" src="kaddra.png" srcset="kaddra.png 1x, kaddra@2x.png 2x">
				</div>
			</a>
	...
	<script src="https://code.jquery.com/jquery-3.6.0.min.js" integrity="sha256-/xUj+3OJU5yExlq6GSYGSHk7tPXikynS7ogEvDej/m4=" crossorigin="anonymous"></script>
	<script src="http://ajax.googleapis.com/ajax/libs/jquery/1.7.1/jquery.min.js" type="text/javascript"></script>
	<script src="../js/kommentare.js"></script>
	<script src="../js/function.js" type="text/javascript"></script>
	<script src="../js/url_copy.js" type="text/javascript"></script>
</body>
