...
<script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-6431831424793010" crossorigin="anonymous"></script>
	...
	<style id="applicationStylesheet" type="text/css">
		...
		* {
		...
		.Rechteck_2_n_Class {
			fill: rgba(243, 29, 60, 1);
		}

		.Rechteck_2_n {
			filter: drop-shadow(0px 13px 16px rgba(0, 0, 0, 0.392));
			position: absolute;
			overflow: visible;
			width: 1136px;
			height: 180px;
		...
		.before_i_close_my_eyes_pj_Class {
			left: 0px;
			top: 19px;
			position: absolute;
			overflow: visible;
		...
		.FIND_OUT_HOW_SATANS_YOUTH_GROU_Class {
			left: 0px;
			top: 8.807px;
			position: absolute;
			overflow: visible;
		...
		.Icon_awesome-soundcloud_Class {
			fill: rgba(239, 85, 107, 1);
		}

		.Icon_awesome-soundcloud {
			overflow: visible;
			position: absolute;
			width: 82.826px;
			height: 39.623px;
		...
		.MUSIKALBUM_Class {
			...
			--web-animation: fadein 0.3s ease-out;
			--web-action-type: page;
			--web-action-target: song_2/songs.php?ID=1;
			cursor: pointer;
			text-align: left;
			font-family: Montserrat;
			font-style: normal;
	...
	?>
		<style>
			.anmelden_Class {
				...
				--web-action-type: page;
				/* --web-action-target: Benutzerverwaltung/logout.php; */
				cursor: pointer;
			}
		</style>
	<?php
	...
	?>
		<style>
			.anmelden_Class {
				...
				--web-animation: fadein 0.6s ease-out;
				--web-action-type: page;
				--web-action-target: Benutzerverwaltung/login.php;
				cursor: pointer;
			}
		</style>
	<?php
	...
	<style>
		...
		.Icon_awesome-spotify_Class {
			fill: rgba(255, 255, 255, 1);
		}

		.Icon_awesome-spotify {
			overflow: visible;
			position: absolute;
			width: 32.779px;
			height: 32.779px;
		...
		#verffentlichungsdatum {
			...
			overflow: hidden;
			--web-view-name: veröffentlichungsdatum;
			--web-view-id: verffentlichungsdatum;
			--web-scale-to-fit: true;
			--web-scale-to-fit-type: width;
			--web-scale-on-resize: true;
			--web-enable-deep-linking: true;
		...
		#Veroeffentlichungsdatum_des_Al {
			filter: drop-shadow(0px 3px 6px rgba(0, 0, 0, 0.161));
			left: 34px;
			top: 17px;
			position: absolute;
...
<body>
	<div id="dashboard" class="dashboard_Class">
		<div data-type="Group" data-name="middle-black-part" class="middle-black-part_Class">
			<svg data-type="Path" data-name="Pfad 505" class="Pfad_505" viewBox="-9.969 1862.594 1972.943 1329.916">
				<path class="Pfad_505_Class" d="M 0.2107203602790833 2103.316162109375 L 1962.973754882812 1862.59375 L 1962.973754882812 3192.509765625 L -9.96875 3192.509765625 L 0.2107203602790833 2103.316162109375 Z">
				</path>
			</svg>
		</div>
		...
		<div data-type="Group" data-name="slidebar" class="slidebar_Class">
			<img data-type="Rectangle" data-name="pictures" class="pictures_Class" src="Bilder/pictures.png" srcset="Bilder/pictures.png 1x">

			<svg data-type="Path" data-name="middle - dreieck" class="middle_-_dreieck" viewBox="1964.243 645.958 2152.42 821.689">
				<path class="middle_-_dreieck_Class" d="M 2073.1826171875 645.9583129882812 L 3039.825927734375 832.2661743164062 L 4048.931884765625 649.345703125 L 4116.66357421875 649.345703125 L 4116.66357421875 1467.647705078125 L 1964.243408203125 1467.647705078125 L 1964.243408203125 645.9583129882812 L 2073.1826171875 645.9583129882812 Z">
				</path>
			</svg>
		</div>
		...
		<div data-type="Group" data-name="slogan" class="slogan_Class">
			<svg data-type="Rectangle" data-name="Rechteck 2" class="Rechteck_2_n">
				<linearGradient id="Rechteck_2_n" spreadMethod="pad" x1="0.5" x2="0.5" y1="0" y2="2.35">
					<stop offset="0" stop-color="#ef556b" stop-opacity="1"></stop>
					<stop offset="1" stop-color="#782b36" stop-opacity="1"></stop>
				</linearGradient>
				<rect class="Rechteck_2_n_Class" rx="0" ry="0" x="0" y="0" width="1088" height="132">
				</rect>
			</svg>
			<div data-type="Text" data-name="THE BEST GROUP ON EARTH" class="THE_BEST_GROUP_ON_EARTH_Class">
				<span>THE BEST GROUP ON EARTH</span>
			</div>
		</div>
		<div data-type="Group" data-name="Songs" class="Songs_Class">
			<div data-type="Repeat Grid" data-name="Wiederholungsraster 1" class="Wiederholungsraster_1_Class">
				<div data-type="Group" data-name="Gruppe 25" class="Gruppe_25 Gruppe_25_Class">
					<div data-type="Group" data-name="Gruppe 24" class="Gruppe_24_Class" onclick="window.location.href = 'song/songs.php?ID=1'">
						<div data-type="Text" data-name="introduction" class="introduction_Class">
							<span> 1er </span>
						</div>
						<div data-type="Text" data-name="01:13" class="n_113_Class">
							<span>02:50</span>
						</div>
						<div data-type="Group" data-name="Gruppe 23" class="Gruppe_23_Class">
							<div data-type="Text" data-name="LISTEN NOW" class="LISTEN_NOW_Class">
								<span>JETZT ANHÖREN</span>
							</div>
							<svg data-type="Rectangle" data-name="Rechteck 3" class="Rechteck_3">
								<rect class="Rechteck_3_Class" rx="5" ry="5" x="0" y="0" width="260" height="47">
								</rect>
							</svg>
						</div>
					</div>
					<svg data-type="Line" data-name="Linie 1" class="Linie_1" viewBox="0 0 812 1">
						<path class="Linie_1_Class" d="M 0 0 L 812 0">
						</path>
					</svg>
				</div>
				<div data-type="Group" data-name="Gruppe 25" class="Gruppe_25 Gruppe_25_ol_Class">
					<div data-type="Group" data-name="Gruppe 24" class="Gruppe_24_om_Class" onclick="window.location.href = 'song/songs.php?ID=2'">
						<div data-type="Text" data-name="ALONE, part 3" class="ALONE_part_3_Class">
							<span>Ich und meine Jungs</span>
						</div>
						<div data-type="Text" data-name="02:31" class="n_231_Class">
							<span>02:44</span>
						</div>
						<div data-type="Group" data-name="Gruppe 23" class="Gruppe_23_op_Class">
							<div data-type="Text" data-name="LISTEN NOW" class="LISTEN_NOW_oq_Class">
								<span>JETZT ANHÖREN</span>
							</div>
							<svg data-type="Rectangle" data-name="Rechteck 3" class="Rechteck_3_or">
								<rect class="Rechteck_3_or_Class" rx="5" ry="5" x="0" y="0" width="260" height="47">
								</rect>
							</svg>
						</div>
					</div>
					<svg data-type="Line" data-name="Linie 1" class="Linie_1_os" viewBox="0 0 812 1">
						<path class="Linie_1_os_Class" d="M 0 0 L 812 0">
						</path>
					</svg>
				</div>
				<div data-type="Group" data-name="Gruppe 25" class="Gruppe_25 Gruppe_25_ot_Class">
					<div data-type="Group" data-name="Gruppe 24" class="Gruppe_24_ou_Class" onclick="window.location.href = 'song/songs.php?ID=4'">
						<div data-type="Text" data-name="hope" class="hope_Class">
							<span>Rosen</span>
						</div>
						<div data-type="Text" data-name="03:02" class="n_302_Class">
							<span>02:39</span>
						</div>
						<div data-type="Group" data-name="Gruppe 23" class="Gruppe_23_ox_Class">
							<div data-type="Text" data-name="LISTEN NOW" class="LISTEN_NOW_oy_Class">
								<span>JETZT ANHÖREN</span>
							</div>
							<svg data-type="Rectangle" data-name="Rechteck 3" class="Rechteck_3_oz">
								<rect class="Rechteck_3_oz_Class" rx="5" ry="5" x="0" y="0" width="260" height="47">
								</rect>
							</svg>
						</div>
					</div>
					<svg data-type="Line" data-name="Linie 1" class="Linie_1_o" viewBox="0 0 812 1">
						<path class="Linie_1_o_Class" d="M 0 0 L 812 0">
						</path>
					</svg>
				</div>
				<div data-type="Group" data-name="Gruppe 25" class="Gruppe_25 Gruppe_25_o_Class">
					<div data-type="Group" data-name="Gruppe 24" class="Gruppe_24_o_Class" onclick="window.location.href = 'song/songs.php?ID=5'">
						<div data-type="Text" data-name="infinity (888)" class="infinity_888_Class">
							<span>Träume</span>
						</div>
						<div data-type="Text" data-name="04:03" class="n_403_Class">
							<span>03:15</span>
						</div>
						<div data-type="Group" data-name="Gruppe 23" class="Gruppe_23_o_Class">
							<div data-type="Text" data-name="LISTEN NOW" class="LISTEN_NOW_o_Class">
								<span>JETZT ANHÖREN</span>
							</div>
							<svg data-type="Rectangle" data-name="Rechteck 3" class="Rechteck_3_o">
								<rect class="Rechteck_3_o_Class" rx="5" ry="5" x="0" y="0" width="260" height="47">
								</rect>
							</svg>
						</div>
					</div>
					<svg data-type="Line" data-name="Linie 1" class="Linie_1_pa" viewBox="0 0 812 1">
						<path class="Linie_1_pa_Class" d="M 0 0 L 812 0">
						</path>
					</svg>
				</div>
				<div data-type="Group" data-name="Gruppe 25" class="Gruppe_25 Gruppe_25_pa_Class">
					<div data-type="Group" data-name="Gruppe 24" class="Gruppe_24_pa_Class" onclick="window.location.href = 'song/songs.php?ID=3'">
						<div data-type="Text" data-name="before i close my eyes" class="before_i_close_my_eyes_Class">
							<span>Museen</span>
						</div>
						<div data-type="Text" data-name="01:57" class="n_157_Class">
							<span>02:39</span>
						</div>
						<div data-type="Group" data-name="Gruppe 23" class="Gruppe_23_pd_Class">
							<div data-type="Text" data-name="LISTEN NOW" class="LISTEN_NOW_pe_Class">
								<span>JETZT ANHÖREN</span>
							</div>
							<svg data-type="Rectangle" data-name="Rechteck 3" class="Rechteck_3_pf">
								<rect class="Rechteck_3_pf_Class" rx="5" ry="5" x="0" y="0" width="260" height="47">
								</rect>
							</svg>
						</div>
					</div>
					<svg data-type="Line" data-name="Linie 1" class="Linie_1_pg" viewBox="0 0 812 1">
						<path class="Linie_1_pg_Class" d="M 0 0 L 812 0">
						</path>
					</svg>
				</div>
			</div>
			<div data-type="Group" data-name="album - covers" class="album_-_covers_Class">

				<img data-type="Rectangle" data-name="Bild 6" class="Bild_6_Class" src="Bilder\kaddra_logo.png" srcset="Bilder\kaddra_logo.png 1x">

			</div>
			<div data-type="Text" data-name="Songs" class="Songs_p_Class">
				<span>Songs</span>
			</div>
		</div>
		<svg data-type="Rectangle" data-name="Rechteck 7" class="Rechteck_7">
			<rect class="Rechteck_7_Class" rx="15.5" ry="15.5" x="0" y="0" width="54" height="31">
			</rect>
		</svg>
		<svg data-type="Rectangle" data-name="Rechteck 3" class="Rechteck_3_qd">
			<rect class="Rechteck_3_qd_Class" rx="15.5" ry="15.5" x="0" y="0" width="113" height="31">
			</rect>
		</svg>
		<div data-type="Symbol" data-name="Komponente 2 – 1" class="Komponente_2___1 Komponente_2__1_Class">
			<svg data-type="Rectangle" data-name="Rechteck 51" class="Rechteck_51">
				<rect class="Rechteck_51_Class" rx="0" ry="0" x="0" y="0" width="1920" height="61">
				</rect>
			</svg>
		</div>
		<div data-type="Group" data-name="about us" class="about_us_Class">
			<div data-type="Text" data-name="About Us" class="About_Us_qm_Class">
				<span>About Us</span>
			</div>
			<div data-type="Text" data-name="Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata " class="Lorem_ipsum_dolor_sit_amet_con_Class">
				<span>Wir sind eine Gruppe von 6 Leuten und unsere Idee ist das Produzieren eines Musikalbums sowie ein Musikvideo, welches auf unserer Gruppenwebseite veröffentlicht wird. Die Musik wurde hauptsächlich im Stil des modernen Deutschraps gehalten, jedoch gibt es einige Züge in Richtung elektronischer Tanzmusik.<br /><br />Diese Lieder wurden auf dieser Webseite veröffentlicht. Diese Songs werden alle eigenständig von Kis Dennis produziert. Zusätzlich wurde das Lieblingslied der Gruppe verfilmt. Dieses Video wurde von Ernst Dominik gedreht. Unser Musikvideo handelt von einer selbst ausgedachten Kurzgeschichte. Die Gruppenbilder für die Website wurden von Josipovic Raphael geschossen. Außerdem hat Jospovic Raphael das gesammte Video geschnitten. Die Nachbearbeitung der Musikvideos, sowie etlicher Bilder wurden von Shenouda Kyrillos übernommen. Die KADDRA-Webseite wurde von Danisman Atilla und Roswald Andreas programmiert.</span>
			</div>
		</div>
		<div id="veroeffentlichungsdatum">
			<div id="inhalt">
				<svg class="Rechteck_1">
					<rect id="Rechteck_1" rx="0" ry="0" x="0" y="0" width="447" height="133">
					</rect>
				</svg>
				<div id="Veroeffentlichungsdatum_des_Al">
					<span>Veröffentlichungsdatum des </span>
					<span style="font-style:normal;font-weight:bold;">Albums</span>
				</div>
				<p id="countdown"></p>
			</div>
<div id="button">
				<button type="submit" id="button_m" onclick="window.location.href='song/songs.php?ID=1'" disabled>
					<div id="jetzt_anhören">
					</div>
				</button>
			</div>
		</div>
		<div data-type="Group" data-name="header - menü" class="header_-_men_Class">
			...
			<a href="teammitglieder/teammitglieder.php">
				<div data-type="Text" data-name="ABOUT US" onclick="application.goToTargetView(event)" class="ABOUT_US_qw_Class">
					<span>TEAMMITGLIEDER</span>
				</div>
			</a>
			<a href="song/songs.php?ID=1">
				<div data-type="Text" data-name="BEHIND THE SCENES" class="BEHIND_THE_SCENES_Class">
					...
					<div data-type="Group" data-name="anmelden" onclick="application.goToTargetView(event)" class="anmelden_Class">
						...
						if ($stmt_select->execute()) {
							if (($record_select = $stmt_select->fetch()) != FALSE) {
								...
								echo "						<div class='dropdown-content' style='padding-left: 0px;'>
								<table style='border-spacing: 15px 5px;'>
		<tr> <th> <a style='text-decoration: none;' href='Benutzerverwaltung/profile.php'> zum Profile gehen</a></th></tr>
		<tr> <th> <a style='text-decoration: none; color:#FF0000;' href='Benutzerverwaltung/logout.php'> Abmelden</a></th></tr>
			...
			<a href="index.php">
				<div data-type="Group" data-name="logo_1" onclick="application.goToTargetView(event)" class="logo_1_Class">
	...
	<script src="js/veroeffentlichungsdatumjs.js"> </script>
